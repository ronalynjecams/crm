<?php
App::uses('JobRequestAssignment', 'Model');

/**
 * JobRequestAssignment Test Case
 */
class JobRequestAssignmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JobRequestAssignment = ClassRegistry::init('JobRequestAssignment');
	}
 ...
 */
	public function tearDown() {
		unset($this->JobRequestAssignment);
