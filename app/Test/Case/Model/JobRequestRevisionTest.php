<?php
App::uses('JobRequestRevision', 'Model');

/**
 * JobRequestRevision Test Case
 */
class JobRequestRevisionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->JobRequestRevision = ClassRegistry::init('JobRequestRevision');
	}
