<?php
App::uses('ProductSourcePropertiesController', 'Controller');

/**
 * ProductSourcePropertiesController Test Case
 */
class ProductSourcePropertiesControllerTest extends ControllerTestCase {
