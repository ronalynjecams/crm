<?php
App::uses('ProductionProcessesController', 'Controller');

/**
 * ProductionProcessesController Test Case
 */
class ProductionProcessesControllerTest extends ControllerTestCase {
