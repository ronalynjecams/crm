<?php
App::uses('DeliveryItenerariesController', 'Controller');

/**
 * DeliveryItenerariesController Test Case
 */
class DeliveryItenerariesControllerTest extends ControllerTestCase {
