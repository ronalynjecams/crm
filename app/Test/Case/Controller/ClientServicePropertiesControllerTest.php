<?php
App::uses('ClientServicePropertiesController', 'Controller');

/**
 * ClientServicePropertiesController Test Case
 */
class ClientServicePropertiesControllerTest extends ControllerTestCase {
