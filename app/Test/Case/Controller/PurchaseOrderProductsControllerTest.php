<?php
App::uses('PurchaseOrderProductsController', 'Controller');

/**
 * PurchaseOrderProductsController Test Case
 */
class PurchaseOrderProductsControllerTest extends ControllerTestCase {
