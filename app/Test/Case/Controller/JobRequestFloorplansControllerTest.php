<?php
App::uses('JobRequestFloorplansController', 'Controller');

/**
 * JobRequestFloorplansController Test Case
 */
class JobRequestFloorplansControllerTest extends ControllerTestCase {
