<?php
App::uses('ProductionCarpentersController', 'Controller');

/**
 * ProductionCarpentersController Test Case
 */
class ProductionCarpentersControllerTest extends ControllerTestCase {
