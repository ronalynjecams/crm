<?php
App::uses('JobRequestRevisionsController', 'Controller');

/**
 * JobRequestRevisionsController Test Case
 */
class JobRequestRevisionsControllerTest extends ControllerTestCase {
