<?php
App::uses('JobRequestAssignmentsController', 'Controller');

/**
 * JobRequestAssignmentsController Test Case
 */
class JobRequestAssignmentsControllerTest extends ControllerTestCase {
