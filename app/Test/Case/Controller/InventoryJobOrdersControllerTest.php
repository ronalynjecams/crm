<?php
App::uses('InventoryJobOrdersController', 'Controller');

/**
 * InventoryJobOrdersController Test Case
 */
class InventoryJobOrdersControllerTest extends ControllerTestCase {
