<?php
App::uses('JobRequestProductsController', 'Controller');

/**
 * JobRequestProductsController Test Case
 */
class JobRequestProductsControllerTest extends ControllerTestCase {
