<?php
App::uses('InventoryProductDetailsController', 'Controller');

/**
 * InventoryProductDetailsController Test Case
 */
class InventoryProductDetailsControllerTest extends ControllerTestCase {
