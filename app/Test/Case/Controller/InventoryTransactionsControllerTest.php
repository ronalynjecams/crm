<?php
App::uses('InventoryTransactionsController', 'Controller');

/**
 * InventoryTransactionsController Test Case
 */
class InventoryTransactionsControllerTest extends ControllerTestCase {
