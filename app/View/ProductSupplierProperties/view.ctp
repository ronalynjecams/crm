...
<tr>
		...
		<td>
			<?php echo time_elapsed_string($productSupplierProperty['ProductSupplierProperty']['created']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo time_elapsed_string($productSupplierProperty['ProductSupplierProperty']['modified']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
