<div class="poRawRequestProperties index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Po Raw Request Properties'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Po Raw Request Property'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($poRawRequestProperties as $poRawRequestProperty): ?>
					<tr>
						<td><?php echo h($poRawRequestProperty['PoRawRequestProperty']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($poRawRequestProperty['PoRawRequest']['id'], array('controller' => 'po_raw_requests', 'action' => 'view', $poRawRequestProperty['PoRawRequest']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $poRawRequestProperty['PoRawRequestProperty']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $poRawRequestProperty['PoRawRequestProperty']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
