<div class="quotationUpdateLogs index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Quotation Update Logs'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Quotation Update Log'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($quotationUpdateLogs as $quotationUpdateLog): ?>
					<tr>
						<td><?php echo h($quotationUpdateLog['QuotationUpdateLog']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($quotationUpdateLog['Quotation']['id'], array('controller' => 'quotations', 'action' => 'view', $quotationUpdateLog['Quotation']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $quotationUpdateLog['QuotationUpdateLog']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $quotationUpdateLog['QuotationUpdateLog']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
