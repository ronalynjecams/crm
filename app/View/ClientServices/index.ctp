	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Client Services'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Client Service'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('service_code'); ?></th>
				...
				<?php foreach ($clientServices as $clientService): ?>
					<tr>
						<td><?php echo h($clientService['ClientService']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($clientService['Client']['name'], array('controller' => 'clients', 'action' => 'view', $clientService['Client']['id'])); ?>
		</td>
						<td><?php echo h($clientService['ClientService']['type']); ?>&nbsp;</td>
						<td><?php echo h($clientService['ClientService']['status']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($clientService['User']['id'], array('controller' => 'users', 'action' => 'view', $clientService['User']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $clientService['ClientService']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $clientService['ClientService']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
