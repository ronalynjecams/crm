<div class="productionLogs index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Production Logs'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Production Log'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('production_carpenter_id'); ?></th>
				...
				<tbody>
				<?php foreach ($productionLogs as $productionLog): ?>
					<tr>
						<td><?php echo h($productionLog['ProductionLog']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($productionLog['ProductionCarpenter']['id'], array('controller' => 'production_carpenters', 'action' => 'view', $productionLog['ProductionCarpenter']['id'])); ?>
						...
						<td><?php echo h($productionLog['ProductionLog']['type']); ?>&nbsp;</td>
						<td><?php echo h($productionLog['ProductionLog']['status']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($productionLog['User']['id'], array('controller' => 'users', 'action' => 'view', $productionLog['User']['id'])); ?>
		</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $productionLog['ProductionLog']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $productionLog['ProductionLog']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $productionLog['ProductionLog']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $productionLog['ProductionLog']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
