<div class="jobRequestTypes index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Job Request Types'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Job Request Type'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($jobRequestTypes as $jobRequestType): ?>
					<tr>
						<td><?php echo h($jobRequestType['JobRequestType']['id']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestType['JobRequestType']['name']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestType['JobRequestType']['created']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestType['JobRequestType']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $jobRequestType['JobRequestType']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $jobRequestType['JobRequestType']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jobRequestType['JobRequestType']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jobRequestType['JobRequestType']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
