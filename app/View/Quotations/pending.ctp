                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($pending_quotation['Quotation']['job_request_id'] != 0) {
                                        ...
                                        echo '<br/><button  class="btn btn-default  btn-icon  add-tooltip jobRequeBtn" data-toggle="tooltip"  data-original-title="With Job Request?"  type="button" data-quoteid="' . $pending_quotation['Quotation']['id'] . '"
                                                            data-jrid="'.$pending_quotation['Quotation']['job_request_id'].'"><i class="fa fa-plus"></i></button>';
                                    }
                                    ?>
                                </td> 
                                <td>
                                    <?php if (AuthComponent::user('role') == 'sales_executive') { ?>
                                         <a href="/quotations/update_quotation?id=<?php echo $pending_quotation['Quotation']['id']; ?>" target="_blank"  class="btn btn-mint btn-icon add-tooltip" data-toggle="tooltip"  data-original-title="Update Quotation?" ><i class="fa fa-edit"></i> </a> 
