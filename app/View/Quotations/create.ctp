...
<div id="page-content">
   <div class="panel">
      <div class="panel-heading">
         <h3 class="panel-title" align="center">
            ...
            <button class="btn btn-info">Save and New</button>
      ...
      <div class="col-sm-12">
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="pending" disabled id="status">
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="form-group">
                           <label class="control-label">Quotation Number </label>
                           <input type="text" id="quotation_id" value="<?php echo $quote_data['Quotation']['id']; ?>">
                           <input type="text" class="form-control" value="<?php if(!is_null($quote_data['Quotation']['quote_number'])) echo $quote_data['Quotation']['quote_number']; ?>"  readonly id="quote_number">
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-sm-12">
                     <div class="col-sm-6">
                        ...
                        <select id="delivery_mode" class="form-control">
                           <?php 
                              if(!is_null($quote_data['Quotation']['delivery_mode'])){ ?>
               ...
               <div id="map-panel-collapse" class="collapse in">
                  <div class="panel-body">
                     ...
                     <div class="form-group col-sm-12" align="center">
                         <button id="bill_ship_save" class="btn btn-warning btn-xs" <?php if($quote_data['Quotation']['delivery_mode']!='deliver') { echo 'disabled'; } ?>> Save Billing and Shipping </button>
                        <button id="bill_save" class="btn btn-info btn-xs" <?php if($quote_data['Quotation']['delivery_mode']!='deliver') { echo 'disabled'; } ?>> Save Billing Only </button>
                        <button id="ship_save" class="btn btn-primary btn-xs" <?php if($quote_data['Quotation']['delivery_mode']!='deliver') { echo 'disabled'; } ?>> Save Shipping Only </button>
                        <br/>
                     </div>
                     <center>
                           ...
                           <tbody>
                               ...
                               <tr>
                                    ...
                                    <td >
                                        ...
                                        ?>
                                        <?php echo '<li class="list-group-item"><b>Other Info : <br/></b>'.$quote_prod['Product']['other_info'].'</li>'; ?>
                   ...
                   <div class="col-sm-5" align="right">
                       <table>
                           ...
                           <tr>
                               ...
                               <td>
                                   <div class="form-group"><input  type="number" step="any" id="delivery_charge" class="form-control" value="0" <?php if($quote_data['Quotation']['delivery_mode']!='deliver') { echo 'readonly'; } ?>></div> 
                               </td>
                           </tr>
                           <tr>
                               <td><b>Discount: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
         ...
         <div class="panel">
            ...
            <div id="terms-panel-collapse" class="collapse in">
               <div class="panel-body"> 
                    <textarea id="terms">asdasd</textarea>
               </div>
            </div>
         </div>
   ...
   <div class="panel">
      <div class="panel-heading">
         <h3 class="panel-title" align="center">
            <button class="btn btn-primary savePendingQuote" data-buttontype="save" <?php if(count($quote_products)==0){ echo 'disabled'; }?>>Save</button>
            <button class="btn btn-info savePendingQuote" data-buttontype="savenew" <?php if(count($quote_products)==0){ echo 'disabled'; }?>>Save and New</button>
...
//    edit product
//    let user select if quotation or fitout 
//    add confirm button for delete product
//    save buttons = done
//    cancel button with confirmation

 // users are required to create quotation before job request
 //so, basically if ano ang nasa quotation yun din ang nasa job request
  //click request for job request button then it will appear on design head
