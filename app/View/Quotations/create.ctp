                                            ...
                                            if($interval_day>=0) {
                                                echo '  
                                                    <div class="input-group mar-btm">
                                                        ...
                                                        <input type="hidden" id="jrID" value="'.$quote_data['Quotation']['id'].'">
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-mint add-tooltip" data-toggle="tooltip" id="openJobRequest" data-original-title="View Job Request"
                                                                    data-jrid="'.$quote_data['Quotation']['job_request_id'].'" type="button"><i class="fa fa-external-link"></i></button>
                                                        </span>
                                                    </div>';
                                            }
                                            else {
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class=" date">
                                            <input type="date" class="form-control" name="date" id="validity_date" value="<?php if (!is_null($quote_data['Quotation']['validity_date'])) { echo $quote_data['Quotation']['validity_date']; } else { echo date('Y-m-d', strtotime('+2 weeks', strtotime(date('Y-m-d')))); } ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">Client 
                                            <button class="btn btn-primary btn-xs" data-target="#create-client-modal" data-toggle="modal"><i class="fa fa-plus"></i></button>
                                        </label>
                                        <select id="client_id" class="form-control">
                                            <?php
                                            if ($quote_data['Quotation']['client_id'] != 0) {
                                        ...
                                        echo '<div class="form-group oldInfo">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" readonly id="contact_persond" value="'.$cp.'" '.$cp_state.'>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="control-label">Contact Number</label>
                                                    <input type="text" class="form-control" readonly id="contact_numberd" value="'.$cn.'" '.$cn_state.'>
                                                </div>
                                                <div class="col-sm-12">
                                                    <label class="control-label">Address</label>
                                                    <input type="text" class="form-control" readonly id="addressd" value="'.$ad.'" '.$cn_state.'>
                                                </div>
                                            </div>
                                        </div>';
                                    } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div id="delivery_date_div_value">
                                ...
                                <!--<div class="input-group input-append date" id="datePicker-deliver">-->
                                    <input type="date" class="form-control" name="date"  id="target_delivery" value="<?php if (!is_null($quote_data['Quotation']['target_delivery'])) echo $quote_data['Quotation']['target_delivery']; ?>" />
                        ...
                        <div id="addresses">
                            ...
                            if ($quote_data['Quotation']['delivery_mode'] == 'deliver') {
                                if ($quote_data['Quotation']['bill_ship_address'] == 1) { ?>
                                    <div id="bill_ship_div"> 
                                        ...
                                        <div class="col-sm-6">  
                                            <div id="bill_ship_div_data"> 
                                                <?php
                                                // echo pr($quote_data['Quotation']['bill_geolocation']);
        ...
        <div class="panel" id="map_div">
            ...
            <div id="map-panel-collapse" class="collapse in">
                <div class="panel-body">
                    ...
                    <!--<input  id="bill_longitude" type="text"> <!-- bill_latitude -->
                    <!--<input id="bill_latitude" type="text">  <!-- bill_longitude -->
                </div>
            </div>
        </div>  
                                        ...
                                        foreach ($quote_products as $quote_prod) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-warning btn-icon btn-xs add-tooltip edit_added_product"
                                                            data-delqprodid='<?php echo $quote_prod['QuotationProduct']['id']; ?>'
                                                            data-toggle="tooltip"
                                                            data-original-title="Edit Item # <?php echo $cnt; ?>"
                                                            data-pid="<?php echo $quote_prod['QuotationProduct']['id']; ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-danger btn-icon btn-xs add-tooltip delete-added-product"
                                                            data-delqprodid='<?php echo $quote_prod['QuotationProduct']['id']; ?>'
                                                            data-toggle="tooltip"
                                                            data-original-title="Delete Item # <?php echo $cnt; ?>">
...
$(document).ready(function(e) {
    var pid = 0;
    $("button.edit_added_product").on('click', function(e) {
        pid = $(this).data('pid');
        ...
        $.get('/quotations/update_qproduct', {pid:pid},
            function(data) {
                if(data.length != 0) {
                    ...
                    // setTimeout('alert($("body").find("#edit-product-modal input#e_initial_prod_type").val())', 1000);
    ...
    $("#e_product_id").change(function () {
        ...
        $.get('/quotations/update_qproduct', {
            ...
            // TEXTAREA
            var e_other_info_set = "";
            if(data['qproduct']['QuotationProduct']['other_info']!="" || data['qproduct']['QuotationProduct']['other_info']!=null) {
                e_other_info_set = data['qproduct']['QuotationProduct']['other_info']
            }
            tinymce.get('e_other_info').setContent(e_other_info_set);
...
// var quoted_price_init = 0;
// $("#select_swatches").on('change', function() {
//     var swatch_id = $(this).val();
//     var data = {"id":swatch_id};
//     var mult_qty_tmp = $('#prod_quantity').val();
//     if(mult_qty_tmp!=""||mult_qty_tmp!=0) {
//         mult_qty = mult_qty_tmp;
//     }
//     else {
//         mult_qty = 1;
//     }
//     // var quoted_price = $('#prod_amount').val()*mult_qty;
//     var quoted_price = $('#prod_amount').val();
    
//     $.ajax({
//         url: "/quotations/get_prod_price",
//         type: "POST",
//         data: {"data": data},
//         dataType: "text",
//         success: function(success) {
//             quoted_price_init = success;
//             console.log(swatch_id+" - success: "+success);
//             if(swatch_id!="---- Select Swatches ----" &&
//               success!=0) {
//                 // quoted_price = success*mult_qty;
//                 quoted_price = success;
//             }
//             $('#edited_amount').attr('value', quoted_price);
//         },
//         error: function(error) {
//             console.log(error);
//             swal({
//                 title: "Oops!",
//                 text: "There was an error in getting swatch's price.\n Please try again.",
//                 type: "warning"
//     		});
//         }
//     });
...
<script>
        ...
        if (product_id != "---- Select Product ----") {
            if(property.length==0) {
                swal({
                    title: "Oops!",
                    text: "Properties and values cannot be empty.\n"+
                          "Please enter atleast one(1) property and value and try again.",
                    type: "warning"
                });
    ...
    $('.savePendingQuote').each(function (index) {
        $(this).click(function () {
            ...
            var isWithBillShip = "<?php echo abs($isWithBillShip); ?>"; 
            var isWithBill = "<?php echo abs($isWithBill); ?>";
            var isWithShip = "<?php echo abs($isWithShip); ?>";
            
            console.log(isWithShip);
            console.log(isWithBill);
            console.log(isWithBillShip);
        ...
        // ================================================================>
            ...
            if(delivery_mode=="deliver") {
                ...
                console.log(bill_geolocation);
                console.log(bill_latitude);
                console.log(bill_longitude);
            }
            console.log('is allowed'+isAllowedToSend);
        // ================================================================>
            var sub_total = $('#sub_total').val();
                                ...
                                if($("#target_delivery").val()!="") {
                                    if(isAllowedToSend) {
                                        ...
                                        if(parseInt(isWithBillShip)===1) {
                                            ...
                                            if(parseInt(isWithBill)===1) {
                                                // alert('isWithBill');
                                                if(parseInt(isWithShip)===1) {
                                                    // alert('isWithShip');
                                                    $.ajax({
                                                        url: "/quotations/edit",
                                                        type: 'POST',
    ...
    $('#openJobRequest').on('click', function (e) {
        jr_id = $(this).data('jrid');
        window.location.href = '/job_requests/view_jr?id='+jr_id;            
    })
