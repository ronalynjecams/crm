                                    ...
                                    <div class="form-group">
                                        ...
                                        if ($quote_data['Quotation']['job_request_id'] != 0) {
                                            ...
                                            <div class="input-group mar-btm">
                                                ...
                                                $jr = '';
                                                $qID = '';
                                                if(!empty($quote_data['JobRequest'])) {
                                                    $jr = $quote_data['JobRequest']['jr_number'];
                                                    $qID = $quote_data['Quotation']['id'];
                                                }
                                                echo '<input type="text" class="form-control" placeholder="Name" readonly value="'.$jr.'">';
                                                echo '<input type="hidden" id="jrID" value="'.$qID.'">'; ?>
...
//console.log($("#installation_charge").val()+'zxczxc');
            var grand_total = parseFloat($('#sub_total').val()) + parseFloat($('#installation_charge').val()) + parseFloat($('#delivery_charge').val()) - parseFloat($('#discount').val());
            $('#grand_total').val(grand_total);
