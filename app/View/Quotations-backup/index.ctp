	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($quotation['User']['id'], array('controller' => 'users', 'action' => 'view', $quotation['User']['id'])); ?>
						...
						<td><?php echo time_elapsed_string($quotation['Quotation']['date_moved']); ?>&nbsp;</td>
						<td><?php echo time_elapsed_string($quotation['Quotation']['date_approved']); ?>&nbsp;</td>
						<td><?php echo h($quotation['Quotation']['delivery_mode']); ?>&nbsp;</td>
						<td><?php echo time_elapsed_string($quotation['Quotation']['created']); ?>&nbsp;</td>
						<td><?php echo time_elapsed_string($quotation['Quotation']['modified']); ?>&nbsp;</td>
						<td class="actions">
