                                ...
                                <td >
                                    ...
                                    foreach ($pending_quotation['Collection'] as $collection) {
                                        ...
                                        if ($collection['status'] != 'verified') {
                                            ...
                                            $unverified_total_collection = $unverified_total_collection + $payment;
                                        }
                                        ...
                                        if($balance>=1){
                                            if($balance == $pending_quotation['Quotation']['grand_total']){
                                                echo '<span class="text-danger"> <small> [ <b> Unverified </b> &#8369; ' . number_format($unverified_total_collection, 2).' ] </small></span>';
                                            }else{
