                                    ...
                                    <div class="form-group">
                                        ...
                                        if ($quote_data['Quotation']['job_request_id'] != 0) {
                                            ...
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="hidden" id="jrID" value="<?php echo $quote_data['Quotation']['id']; ?>">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-mint add-tooltip" data-toggle="tooltip" id="openJobRequest" data-original-title="View Job Request"  type="button"><i class="fa fa-external-link"></i></button>
                                                </span>
                                            </div>
                                            <?php
                                        } else {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" date">
                                            <!--<div class="input-group input-append date" id="datePicker">-->
                                                <input type="date" class="form-control" name="date" id="validity_date" value="<?php if (!is_null($quote_data['Quotation']['validity_date'])) echo $quote_data['Quotation']['validity_date']; ?>" />
...
//                alert(qp_id);
        ...
        $('#openJobRequest').on('click', function (e) {
            var jrID = $("#jrID").val();
            window.location.href = '/job_requests/joupdate?id='+jrID;            
        })
