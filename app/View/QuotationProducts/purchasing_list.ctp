...
<!--===================================================-->
      ...
      <div id="content-container">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div id="page-title">
          <h1 class="page-header text-overflow">Quoted Products</h1>
        </div>
        ...
        <div id="page-content">
          ...
          <div class="panel">
            ...
            <div class="table-responsive">
              <table id="tbl-purchasing-list" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th>Date Moved</th>
                    <th>Image</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#tbl-purchasing-list').dataTable({
        	"stateSave": true,
        	"lengthMenu": [[10,50, 100, 200, -1], [10,50, 100, 200, "All"]],
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $this->Html->Url(array('controller' => 'QuotationProducts', 'action' => 'purchasing_list_ajax')); ?>"
        });
