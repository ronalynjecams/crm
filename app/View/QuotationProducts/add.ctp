	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Quotation Product'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('QuotationProduct', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('edited_amount', array('class' => 'form-control', 'placeholder' => 'Edited Amount'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('sale', array('class' => 'form-control', 'placeholder' => 'Sale'));?>
				</div>
				<div class="form-group">
