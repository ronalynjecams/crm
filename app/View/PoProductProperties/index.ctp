<div class="poProductProperties index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Po Product Properties'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Po Product Property'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('po_product_id'); ?></th>
				...
				<tbody>
				<?php foreach ($poProductProperties as $poProductProperty): ?>
					<tr>
						<td><?php echo h($poProductProperty['PoProductProperty']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($poProductProperty['PoProduct']['id'], array('controller' => 'po_products', 'action' => 'view', $poProductProperty['PoProduct']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $poProductProperty['PoProductProperty']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $poProductProperty['PoProductProperty']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
