	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($paymentRequestLog['User']['id'], array('controller' => 'users', 'action' => 'view', $paymentRequestLog['User']['id'])); ?>
						...
						<td><?php echo time_elapsed_string($paymentRequestLog['PaymentRequestLog']['created']); ?>&nbsp;</td>
						<td><?php echo time_elapsed_string($paymentRequestLog['PaymentRequestLog']['modified']); ?>&nbsp;</td>
						<td class="actions">
