<div class="prodInvLocations index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Prod Inv Locations'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Prod Inv Location'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($prodInvLocations as $prodInvLocation): ?>
					<tr>
						<td><?php echo h($prodInvLocation['ProdInvLocation']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($prodInvLocation['Product']['name'], array('controller' => 'products', 'action' => 'view', $prodInvLocation['Product']['id'])); ?>
						...
						<td><?php echo h($prodInvLocation['ProdInvLocation']['created']); ?>&nbsp;</td>
						<td><?php echo h($prodInvLocation['ProdInvLocation']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $prodInvLocation['ProdInvLocation']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $prodInvLocation['ProdInvLocation']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $prodInvLocation['ProdInvLocation']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $prodInvLocation['ProdInvLocation']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
