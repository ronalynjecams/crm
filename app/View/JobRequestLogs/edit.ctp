<div class="jobRequestLogs form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Edit Job Request Log'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('JobRequestLog.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('JobRequestLog.id'))); ?></li>
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Job Request Logs'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('JobRequestLog', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('job_request_assignment_id', array('class' => 'form-control', 'placeholder' => 'Job Request Assignment Id'));?>
				</div>
				<div class="form-group">
