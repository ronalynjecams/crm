<div class="jrUploads index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Jr Uploads'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Jr Upload'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($jrUploads as $jrUpload): ?>
					<tr>
						<td><?php echo h($jrUpload['JrUpload']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($jrUpload['JrProduct']['id'], array('controller' => 'jr_products', 'action' => 'view', $jrUpload['JrProduct']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $jrUpload['JrUpload']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jrUpload['JrUpload']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jrUpload['JrUpload']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
