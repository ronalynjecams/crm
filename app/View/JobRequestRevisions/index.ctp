<div class="jobRequestRevisions index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Job Request Revisions'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Job Request Revision'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('estimated_finish'); ?></th>
						<th><?php echo $this->Paginator->sort('actual_date_finished'); ?></th>
				...
				<tbody>
				<?php foreach ($jobRequestRevisions as $jobRequestRevision): ?>
					<tr>
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($jobRequestRevision['JobRequestType']['name'], array('controller' => 'job_request_types', 'action' => 'view', $jobRequestRevision['JobRequestType']['id'])); ?>
						...
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['deadline_date']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['estimated_finish']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['actual_date_finished']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($jobRequestRevision['Product']['name'], array('controller' => 'products', 'action' => 'view', $jobRequestRevision['Product']['id'])); ?>
						...
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['created']); ?>&nbsp;</td>
						<td><?php echo h($jobRequestRevision['JobRequestRevision']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $jobRequestRevision['JobRequestRevision']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $jobRequestRevision['JobRequestRevision']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jobRequestRevision['JobRequestRevision']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jobRequestRevision['JobRequestRevision']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
