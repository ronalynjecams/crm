<div class="inventoryTransactions form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Inventory Transaction'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Inventory Transactions'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('InventoryTransaction', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('type_num', array('class' => 'form-control', 'placeholder' => 'Type Num'));?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->Form->input('request_qty', array('class' => 'form-control', 'placeholder' => 'Request Qty'));?>
				</div>
				<div class="form-group">
