<div class="clientServiceProperties index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Client Service Properties'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Client Service Property'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('client_service_product_id'); ?></th>
				...
				<tbody>
				<?php foreach ($clientServiceProperties as $clientServiceProperty): ?>
					<tr>
						<td><?php echo h($clientServiceProperty['ClientServiceProperty']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($clientServiceProperty['ClientServiceProduct']['id'], array('controller' => 'client_service_products', 'action' => 'view', $clientServiceProperty['ClientServiceProduct']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $clientServiceProperty['ClientServiceProperty']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $clientServiceProperty['ClientServiceProperty']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
