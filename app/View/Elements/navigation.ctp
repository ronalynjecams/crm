...
<!--                        <li class="dropdown">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                ...
                                <div class="username hidden-xs"><?php echo $UserIn['User']['first_name'].'  '.$UserIn['User']['last_name']; ?></div>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right panel-default">
                                ...
                                <?php if($UserIn['User']['role'] == 'sales_executive'){ ?>
                                    <div class="pad-all bord-btm">
                                            <p class="text-main mar-btm"><span class="text-bold">10 approved quotations</span> out of 14</p>
                                        <div class="progress progress-sm">
