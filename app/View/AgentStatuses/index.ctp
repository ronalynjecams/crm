...
<div id="content-container">
    <div class="agentStatuses index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Agent Statuses'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Agent Status'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($agentStatuses as $agentStatus): ?>
					<tr>
						<td><?php echo h($agentStatus['AgentStatus']['id']); ?>&nbsp;</td>
						<td><?php echo h($agentStatus['AgentStatus']['quota']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($agentStatus['Team']['name'], array('controller' => 'teams', 'action' => 'view', $agentStatus['Team']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $agentStatus['AgentStatus']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $agentStatus['AgentStatus']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
