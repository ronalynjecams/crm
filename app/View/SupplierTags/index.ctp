<div class="supplierTags index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Supplier Tags'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Supplier Tag'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($supplierTags as $supplierTag): ?>
					<tr>
						<td><?php echo h($supplierTag['SupplierTag']['id']); ?>&nbsp;</td>
						<td><?php echo h($supplierTag['SupplierTag']['name']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($supplierTag['Supplier']['name'], array('controller' => 'suppliers', 'action' => 'view', $supplierTag['Supplier']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $supplierTag['SupplierTag']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $supplierTag['SupplierTag']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
