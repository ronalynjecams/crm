<div class="prodInvCombos index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Prod Inv Combos'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Prod Inv Combo'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($prodInvCombos as $prodInvCombo): ?>
					<tr>
						<td><?php echo h($prodInvCombo['ProdInvCombo']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($prodInvCombo['ProdInvLocation']['id'], array('controller' => 'prod_inv_locations', 'action' => 'view', $prodInvCombo['ProdInvLocation']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $prodInvCombo['ProdInvCombo']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $prodInvCombo['ProdInvCombo']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
