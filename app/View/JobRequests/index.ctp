<div class="jobRequests index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Job Requests'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
				...
				<?php foreach ($jobRequests as $jobRequest): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jobRequest['JobRequest']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jobRequest['JobRequest']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
