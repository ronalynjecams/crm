<div class="fitoutReportComments form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Fitout Report Comment'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Fitout Report Comments'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('FitoutReportComment', array('role' => 'form')); ?>

				<div class="form-group">
					<?php echo $this->Form->input('fitout_report_id', array('class' => 'form-control', 'placeholder' => 'Fitout Report Id'));?>
				</div>
				<div class="form-group">
