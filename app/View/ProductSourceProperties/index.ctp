<div class="productSourceProperties index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Product Source Properties'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Product Source Property'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('product_source_id'); ?></th>
				...
				<tbody>
				<?php foreach ($productSourceProperties as $productSourceProperty): ?>
					<tr>
						<td><?php echo h($productSourceProperty['ProductSourceProperty']['id']); ?>&nbsp;</td>
						<td><?php echo h($productSourceProperty['ProductSourceProperty']['property']); ?>&nbsp;</td>
						<td><?php echo h($productSourceProperty['ProductSourceProperty']['value']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($productSourceProperty['ProductSource']['id'], array('controller' => 'product_sources', 'action' => 'view', $productSourceProperty['ProductSource']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $productSourceProperty['ProductSourceProperty']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $productSourceProperty['ProductSourceProperty']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
