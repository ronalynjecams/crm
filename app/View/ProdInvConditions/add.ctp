<div class="prodInvConditions form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Add Prod Inv Condition'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Prod Inv Conditions'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('ProdInvCondition', array('role' => 'form')); ?>

				<div class="form-group">
					<?php echo $this->Form->input('prod_inv_location_property_id', array('class' => 'form-control', 'placeholder' => 'Prod Inv Location Property Id'));?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->Form->input('conditions', array('class' => 'form-control', 'placeholder' => 'Conditions'));?>
				</div>
				<div class="form-group">
