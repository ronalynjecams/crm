	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($purchaseOrderProduct['SupplierProduct']['id'], array('controller' => 'supplier_products', 'action' => 'view', $purchaseOrderProduct['SupplierProduct']['id'])); ?>
						...
						<td><?php echo time_elapsed_string($purchaseOrderProduct['PurchaseOrderProduct']['created']); ?>&nbsp;</td>
						<td><?php echo time_elapsed_string($purchaseOrderProduct['PurchaseOrderProduct']['modified']); ?>&nbsp;</td>
						<td class="actions">
