<div class="productSuppliers index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Product Suppliers'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Product Supplier'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($productSuppliers as $productSupplier): ?>
					<tr>
						<td><?php echo h($productSupplier['ProductSupplier']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($productSupplier['Supplier']['name'], array('controller' => 'suppliers', 'action' => 'view', $productSupplier['Supplier']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $productSupplier['ProductSupplier']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $productSupplier['ProductSupplier']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $productSupplier['ProductSupplier']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
