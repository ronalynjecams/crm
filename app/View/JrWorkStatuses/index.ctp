<div class="jrWorkStatuses index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Jr Work Statuses'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Jr Work Status'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($jrWorkStatuses as $jrWorkStatus): ?>
					<tr>
			...
			<?php echo $this->Html->link($jrWorkStatus['JrProduct']['id'], array('controller' => 'jr_products', 'action' => 'view', $jrWorkStatus['JrProduct']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $jrWorkStatus['JrWorkStatus']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $jrWorkStatus['JrWorkStatus']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $jrWorkStatus['JrWorkStatus']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $jrWorkStatus['JrWorkStatus']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
