...
<!--					                    <button id="demo-panel-network-refresh" data-toggle="panel-overlay" data-target="#demo-panel-network" class="btn"><i class="demo-pli-repeat-2 icon-lg"></i></button>
		    ...
		    <div class="col-lg-5">
		        <div class="row">
		            <?php if(!empty($getteam['Team'])) { ?>
		            <div class="col-sm-6 col-lg-6">
		                <!--Sparkline Area Chart-->
		                <div class="panel panel-success panel-colorful">
		                    <div class="pad-all">
		                        <p class="text-lg text-semibold"><i class="demo-pli-data-storage icon-fw"></i> Team <?php echo ucwords($getteam['Team']['name']); ?> Sales</p>
		                        <p class="mar-no">
		                        	<a href="/pdfs/print_sales?range=t&&team_id=<?php echo $getteam['Team']['id']; ?>"
		                        	   target="_blank"
		                        	   style="color:white">
				                        Today:
										&#8369; <?php echo number_format($daily['grand_total_team'], 2); ?>
									</a>
		                        </p>
		                        <p class="mar-no"><a href="/pdfs/print_sales?range=m&&team_id=<?php echo $getteam['Team']['id']; ?>" target="_blank" style="color:white">  <?php echo 'For the month of '.$month.': &#8369; '.number_format($monthly['grand_total_team'],2); ?> </a></p>
		                    </div>
		            ...
		            <div class="col-sm-6 col-lg-6">
		                ...
		                <div class="panel panel-info panel-colorful">
		                    <div class="pad-all">
		                        ...
		                        <a href="/pdfs/print_sales?range=y&&team_id=<?php echo $getteam['Team']['id']; ?>" target="_blank" style="color:white">
		                   		<span class="text-2x text-semibold">&#8369; <?php echo number_format($yearly['grand_total_team'], 2);?></span>
		                        <p class="mar-no">
		            ...
		            <div class="col-sm-6 col-lg-6">
		                ...
		                <div class="panel panel-purple panel-colorful">
		                    ...
		                    <div class="pad-all text-center">
		                        <!--Placeholder-->
 								<?php
 									$teamname = ucwords($getteam['Team']['name']);
